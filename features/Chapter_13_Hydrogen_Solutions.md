...
```{code-cell} ipython3
# Keep definitions purely symbolic (NO .expand() here)
psi100 = R_nl(1, 0, r, 1) * Ynm(0, 0, theta, phi).expand(func=True)
psi320 = R_nl(3, 2, r, 1) * Ynm(2, 0, theta, phi).expand(func=True)
psi310 = R_nl(3, 1, r, 1) * Ynm(1, 0, theta, phi).expand(func=True)
psi210 = R_nl(2, 1, r, 1) * Ynm(1, 0, theta, phi).expand(func=True)
...
expect3 = integrate(dv * dipole * psi2 * psi2_conj, (r, 0, oo), (theta, 0, pi), (phi, 0, 2*pi))
```
